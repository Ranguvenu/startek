...
function user_get_user_details($user, $course = null, array $userfields = array()) {
    ...
    /*started added by eabyas for mobile app profile view custom display */

    require_once($CFG->dirroot.'/course/renderer.php');
    require_once($CFG->libdir . '/badgeslib.php');

    /*ended added by eabyas for mobile app profile view custom display */
    ...
    $usersviewContext = [
        ...
        "rolename" => $roleinfo,
        "employeeid" => (isset($userOrg->open_employeeid) && $userOrg->open_employeeid != null) ? $userOrg->open_employeeid : 'N/A',
        "user_email" => $userrecord->email,
        "organization" => $usercostcenter ? $usercostcenter : 'N/A',
        "lob" => $userdepartment ? $userdepartment : 'All',
        ...
        "contactno" => $contact,
        "badgesimg" => $OUTPUT->image_url('badgeicon', 'local_users')->out(),
        "certimg" => $OUTPUT->image_url('certicon', 'local_users')->out(),
        ...
        "prflbgimageurl" => $OUTPUT->image_url('prflbg', 'local_users')->out(),
        "badgescount" => $badgecount,
        "reportingto" => $reporting_username,
        "capabilityedit" => $capabilityedit,
        //"loginasurl" => $loginasurl,
        //"options" => $options,
        "doj"=> (isset($userrecord->open_joindate) && $userrecord->open_joindate > 0) ? date('d-M-Y', $userrecord->open_joindate) : 'N/A',
        "dob"=> (isset($userrecord->open_dateofbirth) &&  $userrecord->open_dateofbirth > 0) ? date('d-M-Y', $userrecord->open_dateofbirth) : 'N/A',
    ...
    return array_merge($userdetails,$usersviewContext);
}
