...
class core_user_external extends \core_external\external_api {
    ...
    public static function user_description($additionalfields = array()) {
        $userfields = array(
            ...
            'userimage' => new external_value(PARAM_RAW, 'user image', VALUE_OPTIONAL),
            'rolename' => new external_value(PARAM_RAW, 'user rolename', VALUE_OPTIONAL),
            'employeeid' => new external_value(PARAM_RAW, 'user employeeid', VALUE_OPTIONAL),
            'user_email' => new external_value(PARAM_RAW, 'user email', VALUE_OPTIONAL),
            'organization' => new external_value(PARAM_RAW, 'user organization', VALUE_OPTIONAL),
            'lob' => new external_value(PARAM_RAW, 'user lob', VALUE_OPTIONAL),
            'subdepartment' => new external_value(PARAM_RAW, 'user subdepartment', VALUE_OPTIONAL),
            'location' => new external_value(PARAM_RAW, 'user location', VALUE_OPTIONAL),
            'timezone' => new external_value(PARAM_RAW, 'user timezone', VALUE_OPTIONAL),
            'address' => new external_value(PARAM_RAW, 'user address', VALUE_OPTIONAL),

            'designation' => new external_value(PARAM_RAW, 'user designation', VALUE_OPTIONAL, VALUE_OPTIONAL),
            'client' => new external_value(PARAM_RAW, 'user client', VALUE_OPTIONAL),
            'team' => new external_value(PARAM_RAW, 'user team', VALUE_OPTIONAL),
            'grade' => new external_value(PARAM_RAW, 'user grade', VALUE_OPTIONAL),
            'hrmrole' => new external_value(PARAM_RAW, 'user hrmrole', VALUE_OPTIONAL),
            'zone' => new external_value(PARAM_RAW, 'user zone', VALUE_OPTIONAL),
            'region' => new external_value(PARAM_RAW, 'user region', VALUE_OPTIONAL),
            'employment_type' => new external_value(PARAM_RAW, 'user employment_type', VALUE_OPTIONAL),
            'contactno' => new external_value(PARAM_RAW, 'user contactno', VALUE_OPTIONAL),
            'badgesimg' => new external_value(PARAM_URL, 'user badgesimg', VALUE_OPTIONAL),
            'certimg' => new external_value(PARAM_RAW, 'user certimg', VALUE_OPTIONAL),
            'navigationdata' => new external_value(PARAM_RAW, 'user navigationdata', VALUE_OPTIONAL),

            'prflbgimageurl' => new external_value(PARAM_RAW, 'user prflbgimageurl', VALUE_OPTIONAL),
            'badgescount' => new external_value(PARAM_RAW, 'user badgescount', VALUE_OPTIONAL),
            'reportingto' => new external_value(PARAM_RAW, 'user reportingto', VALUE_OPTIONAL),
            'capabilityedit' => new external_value(PARAM_RAW, 'user capabilityedit'),
            'doj' => new external_value(PARAM_RAW, 'user doj'),
            'dob' => new external_value(PARAM_RAW, 'user dob', VALUE_OPTIONAL),

            'userterritory' => new external_value(PARAM_RAW, 'user territory', VALUE_OPTIONAL),
            'usercu' => new external_value(PARAM_RAW, 'user usercu', VALUE_OPTIONAL),
            'gender' => new external_value(PARAM_RAW, 'user gender', VALUE_OPTIONAL),
            'prefix' => new external_value(PARAM_RAW, 'user prefix', VALUE_OPTIONAL),
            'pluginposition' => new external_value(PARAM_RAW, 'user pluginposition', VALUE_OPTIONAL),
            'domain' => new external_value(PARAM_RAW, 'user domain', VALUE_OPTIONAL),
            'position' => new external_value(PARAM_RAW, 'user position', VALUE_OPTIONAL),
