...
$string['description'] = 'Restrict access after a specified day offset is reached relative to the course start date / enrollment date.';
$string['pluginname'] = 'Restriction by days offset from start';
$string['full_days'] = 'Available upto day <strong>{$a}</strong> from course start date';
$string['short_days'] = 'Available upto day <strong>{$a}</strong> from enrollment day';
$string['title'] = 'Days';
