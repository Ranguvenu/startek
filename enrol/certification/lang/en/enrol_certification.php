...
$string['newenrols_desc'] = 'Allow users to  enrol into new courses via certification.';
...
$string['pluginname'] = 'certification enrolment';
$string['pluginname_desc'] = 'The  certification enrolment plugin allows users to choose which courses they want to participate in. The courses may be protected by an enrolment key. Internally the enrolment is done via the manual enrolment plugin which has to be enabled in the same course.';
$string['requirepassword'] = 'Require enrolment key';
$string['requirepassword_desc'] = 'Require enrolment key in new courses and prevent removing of enrolment key from existing courses.';
$string['role'] = 'Default assigned role';
$string['self:config'] = 'Configure  certification enrol instances';
$string['self:holdkey'] = 'Appear as the  certification enrolment key holder';
$string['self:manage'] = 'Manage enrolled users';
$string['self:unenrol'] = 'Unenrol users from course';
$string['self:unenrolself'] = 'Unenrol  certification from the course';
...
$string['certification:config'] = 'Configure certification enrol instances';
$string['certification:enrol'] = 'Enrol users';
$string['certification:manage'] = 'Manage user enrolments';
$string['certification:unenrol'] = 'Unenrol users from the course';
$string['certification:unenrolself'] = 'Unenrol self from the course';
$string['certification:holdkey'] = 'Certification Holdkey';