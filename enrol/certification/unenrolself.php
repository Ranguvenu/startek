...
$instance = $DB->get_record('enrol', array('id'=>$enrolid, 'enrol'=>'certification'), '*', MUST_EXIST);
...
$PAGE->set_url('/enrol/certification/unenrolself.php', array('enrolid'=>$instance->id));
...
$message = get_string('unenrolselfconfirm', 'enrol_certification', format_string($course->fullname));
