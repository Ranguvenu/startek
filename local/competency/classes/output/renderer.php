...
class renderer extends plugin_renderer_base {
    ...
    public function render_manage_competency_frameworks_page(manage_competency_frameworks_page $page) {
        ...
        return parent::render_from_template('local_competency/manage_competency_frameworks_page', $data);
    }
    ...
    public function render_manage_competencies_page(manage_competencies_page $page) {
        $data = $page->export_for_template($this);
        return parent::render_from_template('local_competency/manage_competencies_page', $data);
    }
     ...
     * Defer to template.
     *
     * @param view_competencies_page $page
     *
     * @return string html for the page
     */
    public function render_view_competencies_page(view_competencies_page $page) {
        $data = $page->export_for_template($this);
        return parent::render_from_template('local_competency/view_competencies_page', $data);
    }
     ...
     * Defer to template.
     *
     * @param user_competency_brief $page
     *
     * @return string html for the page
     */
    public function render_user_competency_brief(user_competency_brief $page) {
        $data = $page->export_for_template($this);
        return parent::render_from_template('local_competency/user_competency_brief', $data);
    }
    ...
    public function render_course_competencies_page(course_competencies_page $page) {
        $data = $page->export_for_template($this);
        return parent::render_from_template('local_competency/course_competencies_page', $data);
    }
    ...
    public function render_template_competencies_page(template_competencies_page $page) {
        $data = $page->export_for_template($this);
        return parent::render_from_template('local_competency/template_competencies_page', $data);
    }
    ...
    public function render_manage_templates_page(manage_templates_page $page) {
        $data = $page->export_for_template($this);
        return parent::render_from_template('local_competency/manage_templates_page', $data);
    }
    ...
    public function render_plan_page(plan_page $page) {
        $data = $page->export_for_template($this);
        return parent::render_from_template('local_competency/plan_page', $data);
    }
    ...
    public function render_plans_page(plans_page $page) {
        $data = $page->export_for_template($this);
        return parent::render_from_template('local_competency/plans_page', $data);
    }
    ...
    public function render_related_competencies_section(renderable $page) {
        $data = $page->export_for_template($this);
        return parent::render_from_template('local_competency/related_competencies', $data);
    }
    ...
    public function render_user_competency_summary_in_course(user_competency_summary_in_course $page) {
        $data = $page->export_for_template($this);
        return parent::render_from_template('local_competency/user_competency_summary_in_course', $data);
    }
    ...
    public function render_user_competency_summary_in_plan(user_competency_summary_in_plan $page) {
        $data = $page->export_for_template($this);
        return parent::render_from_template('local_competency/user_competency_summary_in_plan', $data);
    }
    ...
    public function render_user_evidence_page(user_evidence_page $page) {
        $data = $page->export_for_template($this);
        return parent::render_from_template('local_competency/user_evidence_page', $data);
    }
    ...
    public function render_user_evidence_list_page(user_evidence_list_page $page) {
        $data = $page->export_for_template($this);
        return parent::render_from_template('local_competency/user_evidence_list_page', $data);
    }
    ...
    public function render_user_competency_course_navigation(user_competency_course_navigation $nav) {
        ...
        return parent::render_from_template('local_competency/user_competency_course_navigation', $data);
    }
    ...
    public function render_competency_plan_navigation(competency_plan_navigation $nav) {
        $data = $nav->export_for_template($this);
        return parent::render_from_template('local_competency/competency_plan_navigation', $data);
    }
    ...
    public function render_user_competency_summary(user_competency_summary $page) {
        $data = $page->export_for_template($this);
        return parent::render_from_template('local_competency/user_competency_summary', $data);
    }
