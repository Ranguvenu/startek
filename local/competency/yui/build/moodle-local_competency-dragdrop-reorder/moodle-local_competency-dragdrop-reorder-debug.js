YUI.add('moodle-local_competency-dragdrop-reorder', function (Y, NAME) {
 ...
 *
 * @class M.local_competency.dragdrop_reorder
 * @constructor
...
Y.extend(DRAGREORDER, M.core.dragdrop, {
    ...
    NAME: 'local_competency-dragdrop-reorder',
    ATTRS: {
    }
});

M.local_competency = M.local_competency || {};
M.local_competency.dragdrop_reorder = function(params) {
