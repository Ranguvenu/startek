@tool @javascript @local_competency @local_competency_framework
Feature: Manage competency frameworks
  ...
  Scenario: Create a new framework
    ...
    And I click on "//input[@data-field='local_competency_scale_default_1']" "xpath_element"
    And I click on "//input[@data-field='local_competency_scale_proficient_1']" "xpath_element"
