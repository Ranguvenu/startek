...
$string['nocompetency'] = 'No competency is available';
$string['competencyview']='competencyview';
$string['local_competencyview_desc']='Two views,</br>
        One is Basic view, it show up only user assigned competency in brief.
        </br> Another one Advanced view, it show up courselist and activitieslist assigned to competency';
$string['left_menu_mycompetency'] = 'My Competencies';
$string['competencyparents'] = 'parents';
$string['activitiesassignedtocompetency'] = 'Activities assigned to competency';
$string['availableactivitiesinthecourse'] = 'Available activities in the course';
