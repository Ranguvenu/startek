...
define(['core/ajax', 'core/notification', 'core/templates', 'local_competency/tree', 'local_competency/competency_outcomes', 'jquery'],
    ...
    /** @var {Number} competencyFrameworkId - The current framework id */
    var competencyFrameworksId = 0;

    /** @var {String} competencyFrameworkShortName - The current framework short name */
    var competencyFrameworksShortName = '';
    ...
    var loadCompetencies = function(searchtext) {
      ...
      templates.render('local_competency/loading', {}).done(function(loadinghtml, loadingjs) {
        ...
        */
       // for (competencyFrameworkId=0; carindex<cars.length; carindex++){
        $.each(competencyFrameworksId, function( index, frameworkid ) {
                  treeSelector =treeSelectors[index];
           ...
           competencyFrameworkId = frameworkid;
           competencyFrameworkShortName = competencyFrameworksShortName[index];
         /*   var promises = ajax.call([{
            ...
            children =searchCompetency(frameworkid, searchtext);
    ...
    return /** @alias module:local_competency/competencytree */ {
         ...
         */
        init: function( id, shortname, search, selector, canmanage, currentselector) {

         /*   console.log(id);
            console.log(shortname);
            console.log(selector); */
            competencyFrameworksId = id;
            competencyFrameworksShortName = shortname;
            competencyFramworkCanManage = canmanage;
            treeSelectors = selector;
        ...
        on: function(eventname, handler) {
           ...
           // console.log(handler);
           // console.log(treeSelector);
           //treeSelector ='[data-enhance=tree3]';
           // treeSelector=currentselector;
