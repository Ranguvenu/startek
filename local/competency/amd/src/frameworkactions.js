 ...
 *
 * @module     local_competency/frameworkactions
...
define(['jquery', 'core/templates', 'core/ajax', 'core/notification', 'core/str'], function($, templates, ajax, notification, str) {
    ...
    var reloadList = function(context) {
        templates.render('local_competency/manage_competency_frameworks_page', context)
            .done(updatePage)
    ...
    var doDuplicate = function(e) {
        ...
        var requests = ajax.call([{
            ...
            methodname: 'local_competency_data_for_competency_frameworks_manage_page',
            args: {
                pagecontext: {
        ...
        requests[0].done(function(success) {
            if (success === false) {
                ...
                req[0].done(function(framework) {
                    str.get_strings([
                        {key: 'frameworkcannotbedeleted', component: 'local_competency', param: framework.shortname},
    ...
    var confirmDelete = function(e) {
        ...
        requests[0].done(function(framework) {
            str.get_strings([
                ...
                {key: 'deletecompetencyframework', component: 'local_competency', param: framework.shortname},
    ...
    return /** @alias module:local_competency/frameworkactions */ {
