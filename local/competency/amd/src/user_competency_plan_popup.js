...
define(['jquery', 'core/notification', 'core/str', 'core/ajax', 'core/templates', 'local_competency/dialogue'],
    ...
    UserCompetencyPopup.prototype._handleClick = function(e) {
        ...
        var requests = ajax.call([{
            methodname: 'local_competency_data_for_user_competency_summary_in_plan',
    ...
    UserCompetencyPopup.prototype._contextLoaded = function(context) {
        var self = this;
        templates.render('local_competency/user_competency_summary_in_plan', context).done(function(html, js) {
    ...
    UserCompetencyPopup.prototype._pageContextLoaded = function(context) {
        var self = this;
        templates.render('local_competency/plan_page', context).done(function(html, js) {
    ...
    return /** @alias module:local_competency/user_competency_plan_popup */ UserCompetencyPopup;
