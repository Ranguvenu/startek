 ...
 *
 * @module     local_competency/user_evidence_actions
...
define(['jquery',
        ...
        'local_competency/competencypicker_user_plans'],
    ...
    var UserEvidenceActions = function(type) {
        ...
        if (type === 'evidence') {
            ...
            this._template = 'local_competency/user_evidence_page';
            this._contextMethod = 'local_competency_data_for_user_evidence_page';
            ...
            this._template = 'local_competency/user_evidence_list_page';
            this._contextMethod = 'local_competency_data_for_user_evidence_list_page';
    ...
    UserEvidenceActions.prototype.deleteEvidence = function(evidenceData) {
        ...
        requests[0].done(function(evidence) {
            str.get_strings([
                ...
                {key: 'deleteuserevidence', component: 'local_competency', param: evidence.name},
    ...
    UserEvidenceActions.prototype.reviewUserEvidenceCompetencies = function(evidenceData) {
        ...
        requests[0].done(function(evidence) {
            str.get_strings([
                {key: 'confirm', component: 'moodle'},
                {key: 'sendallcompetenciestoreview', component: 'local_competency', param: evidence.name},
                {key: 'confirm', component: 'moodle'},
                {key: 'cancel', component: 'moodle'}
            ]).done(function(strings) {
                notification.confirm(
    ...
    return /** @alias module:local_competency/user_evidence_actions */ UserEvidenceActions;
});
