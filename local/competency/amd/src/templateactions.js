 ...
 *
 * @module     local_competency/templateactions
 * @package    local_competency
 * @copyright  2015 Damyon Wiese <damyon@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
define(['jquery', 'core/templates', 'core/ajax', 'core/notification', 'core/str', 'local_competency/actionselector'],
    ...
    var reloadList = function(context) {
        templates.render('local_competency/manage_templates_page', context)
            .done(updatePage)
    ...
    var doDelete = function() {
        ...
        var requests = ajax.call([{
            ...
            methodname: 'local_competency_data_for_templates_manage_page',
            args: {
                pagecontext: {
        ...
        requests[0].done(function(template) {
            requests[1].done(function(templatehasrelateddata) {
                if (templatehasrelateddata) {
                    str.get_strings([
                        {key: 'deletetemplate', component: 'local_competency', param: template.shortname},
                        {key: 'deletetemplatewithplans', component: 'local_competency'},
                        {key: 'deleteplans', component: 'local_competency'},
                        {key: 'unlinkplanstemplate', component: 'local_competency'},
    ...
    return /** @alias module:local_competency/templateactions */ {
