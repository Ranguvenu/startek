...
define(['jquery',
    ...
    Picker.prototype.display = function() {
        var self = this;
        return $.when(Str.get_string('competencypicker', 'local_competency'), self._render())
    ...
    Picker.prototype._render = function() {
        ...
        return self._preRender().then(function() {
            ...
            return Templates.render('local_competency/competency_picker', context);
        });
    };
    ...
    return /** @alias module:local_competency/competencypicker */ Picker;
