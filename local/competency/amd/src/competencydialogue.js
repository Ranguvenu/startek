 ...
 *
 * @module     local_competency/Competencydialogue
...
define(['jquery',
    ...
    Competencydialogue.prototype.showDialogue = function(competencyid, options) {
        ...
        datapromise.done(function(data) {
            ...
            templates.render('local_competency/competency_summary', data)
                .done(function(html) {
    ...
    Competencydialogue.prototype.showDialogueFromData = function(dataSource) {
        ...
        var localthis = this;
        // Inner Html in the dialogue content.
        templates.render('local_competency/competency_summary', dataSource)
            .done(function(html) {
                // Log competency viewed event.
    ...
    Competencydialogue.prototype.getCompetencyDataPromise = function(competencyid, options) {
        ...
        var requests = ajax.call([
            {methodname: 'local_competency_data_for_competency_summary',
    ...
    return /** @alias module:local_competency/competencydialogue */ {
