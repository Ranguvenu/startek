...
define(['jquery',
        'core/str',
        'core/templates',
        'local_competency/competency_rule',
        ],
    ...
    Rule.prototype.injectTemplate = function(container) {
        ...
        return Templates.render('local_competency/competency_rule_points', context).then(function(html) {
    ...
    return /** @alias module:local_competency/competency_rule_all */ Rule;
