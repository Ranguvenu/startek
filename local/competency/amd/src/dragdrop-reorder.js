 ...
 *
 * @module     local_competency/dragdrop-reorder
...
define(['core/str', 'core/yui'], function(str, Y) {
     ...
     *
     * @property dragDropInstance M.local_competency.dragdrop_reorder
     */
    ...
    return /** @alias module:local_competency/dragdrop-reorder */ {
        // Public variables and functions.
        /**
         * Create an instance of M.local_competency.dragdrop
         *
        ...
        dragdrop: function(group,
            ...
            str.get_strings([
                ...
                Y.use('moodle-local_competency-dragdrop-reorder', function() {
                    ...
                    dragDropInstance = M.local_competency.dragdrop_reorder({
                        group: group,
