 ...
 *
 * @module     local_competency/parentcompetency_form
 * @package    local_competency
 * @copyright  2015 Issam Taboubi <issam.taboubi@umontreal.ca>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
define(['jquery', 'core/ajax', 'core/str', 'local_competency/competencypicker', 'core/templates', 'core/notification'],
    ...
    ParentCompetencyForm.prototype.setParent = function(data) {
        ...
        if (data.competencyId !== 0) {
            ...
            Str.get_string('competencyframeworkroot', 'local_competency').then(function(rootframework) {
        ...
        $(self.buttonSelector).on('click', function(e) {
            ...
            picker._render = function() {
                ...
                return self._preRender().then(function() {
                    ...
                    return Templates.render('local_competency/competency_picker_competencyform', context);
                });
            };
