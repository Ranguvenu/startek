...
define(['jquery',
    ...
    RuleConfig.prototype.display = function() {
        ...
        return $.when(Str.get_string('competencyrule', 'local_competency'), self._render())
    ...
    RuleConfig.prototype._render = function() {
        ...
        return this._preRender().then(function() {
            ...
            return Templates.render('local_competency/competency_rule_config', context);
        });
    };
    ...
    return /** @alias module:local_competency/competencyruleconfig */ RuleConfig;
