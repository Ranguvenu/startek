...
define(['jquery', 'core/notification', 'core/ajax', 'core/templates'], function($, notification, ajax, templates) {
    ...
    var Info = function(rootElement, competencyId, userId, planId, courseId, displayuser) {
        ...
        if (this._planId) {
            this._methodName = 'local_competency_data_for_user_competency_summary_in_plan';
            this._args = {competencyid: this._competencyId, planid: this._planId};
            this._templateName = 'local_competency/user_competency_summary_in_plan';
        } else if (this._courseId) {
            this._methodName = 'local_competency_data_for_user_competency_summary_in_course';
            this._args = {userid: this._userId, competencyid: this._competencyId, courseid: this._courseId};
            this._templateName = 'local_competency/user_competency_summary_in_course';
        } else {
            this._methodName = 'local_competency_data_for_user_competency_summary';
            this._args = {userid: this._userId, competencyid: this._competencyId};
            this._templateName = 'local_competency/user_competency_summary';
        }
    };
    ...
    return /** @alias module:local_competency/user_competency_info */ Info;
