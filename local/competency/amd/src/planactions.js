 ...
 *
 * @module     local_competency/planactions
...
define(['jquery',
    ...
    var PlanActions = function(type) {
        ...
        if (type === 'plan') {
            ...
            this._template = 'local_competency/plan_page';
            this._contextMethod = 'local_competency_data_for_plan_page';

        } else if (type === 'plans') {
            // This is the page to view a list of plans.
            this._region = '[data-region="plans"]';
            this._planNode = '[data-region="plan-node"]';
            this._template = 'local_competency/plans_page';
            this._contextMethod = 'local_competency_data_for_plans_page';
    ...
    PlanActions.prototype.deletePlan = function(planData) {
        ...
        requests[0].done(function(plan) {
            str.get_strings([
                ...
                {key: 'deleteplan', component: 'local_competency', param: plan.name},
    ...
    PlanActions.prototype.reopenPlan = function(planData) {
        ...
        requests[0].done(function(plan) {
            str.get_strings([
                {key: 'confirm', component: 'moodle'},
                {key: 'reopenplanconfirm', component: 'local_competency', param: plan.name},
                {key: 'reopenplan', component: 'local_competency'},
                {key: 'cancel', component: 'moodle'}
            ]).done(function(strings) {
                notification.confirm(
                    strings[0], // Confirm.
    ...
    PlanActions.prototype.completePlan = function(planData) {
        ...
        requests[0].done(function(plan) {
            str.get_strings([
                {key: 'confirm', component: 'moodle'},
                {key: 'completeplanconfirm', component: 'local_competency', param: plan.name},
                {key: 'completeplan', component: 'local_competency'},
                {key: 'cancel', component: 'moodle'}
            ]).done(function(strings) {
                notification.confirm(
                    strings[0], // Confirm.
    ...
    PlanActions.prototype.unlinkPlan = function(planData) {
        ...
        requests[0].done(function(plan) {
            str.get_strings([
                {key: 'confirm', component: 'moodle'},
                {key: 'unlinkplantemplateconfirm', component: 'local_competency', param: plan.name},
                {key: 'unlinkplantemplate', component: 'local_competency'},
                {key: 'cancel', component: 'moodle'}
            ]).done(function(strings) {
                notification.confirm(
                    strings[0], // Confirm.
