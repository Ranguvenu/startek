 ...
 *
 * @module     local_competency/form-cohort-selector
...
define(['jquery', 'core/ajax', 'core/templates'], function($, Ajax, Templates) {
    ...
    return /** @alias module:local_competency/form-cohort-selector */ {
        ...
        transport: function(selector, query, success, failure) {
            ...
            promise = Ajax.call([{
                methodname: 'local_competency_search_cohorts',
                args: {
                    query: query,
            ...
            promise[0].then(function(results) {
                ...
                $.each(results.cohorts, function(index, cohort) {
                    promises.push(Templates.render('local_competency/form-cohort-selector-suggestion', cohort));
                });
