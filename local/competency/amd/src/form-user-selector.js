 ...
 *
 * @module     local_competency/form-user-selector
...
define(['jquery', 'core/ajax', 'core/templates'], function($, Ajax, Templates) {
    ...
    return /** @alias module:local_competency/form-user-selector */ {
        ...
        transport: function(selector, query, success, failure) {
            ...
            promise = Ajax.call([{
                methodname: 'local_competency_search_users',
                args: {
                    query: query,
            ...
            promise[0].then(function(results) {
                ...
                $.each(results.users, function(index, user) {
                    ...
                    promises.push(Templates.render('local_competency/form-user-selector-suggestion', ctx));
                });
