...
class certification_completions_settings_created extends \core\event\base {
    /**
     * Init method.
     *
     * @return void
    ...
    public function get_description() {
        ...
        $certification_id=$DB->get_field_sql("SELECT certificationid FROM {local_certificatn_completion} where id=$this->objectid");
        if($certification_id){
            ...
            return get_string("strcerficationidcscreated",'local_certification',$stringHelper);
        }else{
            $stringHelper=new stdClass();
            $stringHelper->userid=$this->userid;
            $stringHelper->objectid=$this->objectid;
            return get_string("strcerficationcscreated",'local_certification',$stringHelper);
        }
    ...
    public static function get_name() {
        return get_string('eventcertificationcompletions_settings_created', 'local_certification');
    }
