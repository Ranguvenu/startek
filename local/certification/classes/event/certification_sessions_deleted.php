...
class certification_sessions_deleted extends \core\event\base {
    /**
     * Init method.
     *
     * @return void
    ...
    public function get_description() {
        ...
        $certification_sessions_name=$DB->get_field_sql("SELECT name FROM {local_certification_sessions} where id=$this->objectid");
        if($certification_sessions_name){
            $certification_id=$DB->get_field_sql("SELECT certificationid FROM {local_certification_sessions} where id=$this->objectid");
            ...
            return get_string("strcerficationnamesessiondeleted",'local_certification',$stringHelper);
        }else{
            $stringHelper=new stdClass();
            $stringHelper->firstname=$firstname;
            $stringHelper->userid=$this->userid;
            $stringHelper->objectid=$this->objectid;
            return get_string("strcerficationsessiondeleted",'local_certification',$stringHelper);
        }
    }
    ...
    public static function get_name() {
        return get_string('eventcertificationsessions_deleted', 'local_certification');
    }
