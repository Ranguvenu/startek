...
class certification_deleted extends \core\event\base {
    /**
     * Init method.
     *
     * @return void
    ...
    public function get_description() {
       ...
       if($certification_name){
            ...
            return get_string("strcerficationnamedeleted",'local_certification',$stringHelper);
       }else{
            $stringHelper=new stdClass();
            $stringHelper->firstname=$firstname;
            $stringHelper->userid=$this->userid;
            $stringHelper->objectid=$this->objectid;
            return get_string("strcerficationdeleted",'local_certification',$stringHelper);
       }
    }
    ...
    public static function get_name() {
        return get_string('eventcertificationdeleted', 'local_certification');
    }
