...
class certification_users_created extends \core\event\base {
    /**
     * Init method.
     *
     * @return void
    ...
    public function get_description() {
        ...
        $userid=$DB->get_field_sql("SELECT userid FROM {local_certification_users} where id=$this->objectid");
        if($userid){
            
            $certification_users_name=$DB->get_field_sql("SELECT concat(firstname,' ',lastname) FROM {user} where id=$userid");
            $certification_id=$DB->get_field_sql("SELECT certificationid FROM {local_certification_users} where id=$this->objectid");
            ...
            return get_string("strcerficationusersnamecreated",'local_certification',$stringHelper);
            ...
            $stringHelper->userid=$this->userid;
            $stringHelper->objectid=$this->objectid;
            return get_string("strcerficationuserscreated",'local_certification',$stringHelper);
        }
    }
    ...
    public static function get_name() {
        return get_string('eventcertificationusers_created', 'local_certification');
    }
    ...
    public function get_url() {
        ...
        $certification_id=$DB->get_field_sql("SELECT certificationid FROM {local_certification_users} where id=$this->objectid");
       if($certification_id){
        $url = new \moodle_url('/local/certification/enrollusers.php',array('ctid'=>$certification_id));
       }else{
