...
class certification_updated extends \core\event\base {
    ...
    public function get_description() {
        ...
        $certification_name=$DB->get_field_sql("SELECT name FROM {local_certification} where id=$this->objectid");
        if($certification_name){
            ...
            return get_string("strcerficationnameupdated",'local_certification',$stringHelper);
        }else{
             $stringHelper=new stdClass();
            $stringHelper->firstname=$firstname;
            $stringHelper->userid=$this->userid;
            $stringHelper->objectid=$this->objectid;
            return get_string("strcerficationupdated",'local_certification',$stringHelper);
        }
    ...
    public static function get_name() {
        return get_string('eventcertificationupdated', 'local_certification');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->objectid, 'certification', 'update certification', $logurl, $this->objectid, $this->contextinstanceid);
    }
