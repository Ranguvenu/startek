...
class certification_hold extends \core\event\base {
    /**
     * Init method.
     *
     * @return void
    ...
    public function get_description() {
        ...
        if($certification_name){
            ...
            return get_string("strcerficationnamehold",'local_certification',$stringHelper);
            ...
            $stringHelper->userid=$this->userid;
            $stringHelper->objectid=$this->objectid;
            return get_string("strcerficationhold",'local_certification',$stringHelper);
        }
    ...
    public static function get_name() {
        return get_string('eventcertificationhold', 'local_certification');
    }
