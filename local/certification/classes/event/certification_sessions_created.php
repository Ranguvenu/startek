...
class certification_sessions_created extends \core\event\base {
    /**
     * Init method.
     *
     * @return void
    ...
    public function get_description() {
        ...
        if($certification_sessions_name){
            ...
            return get_string("strcerficationnamesessioncreated",'local_certification',$stringHelper);
            ...
            $stringHelper->userid=$this->userid;
            $stringHelper->objectid=$this->objectid;
            return get_string("strcerficationsessioncreated",'local_certification',$stringHelper);
        }
    }
    ...
    public static function get_name() {
        return get_string('eventcertificationsessions_created', 'local_certification');
    }
