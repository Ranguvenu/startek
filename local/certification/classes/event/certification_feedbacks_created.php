...
class certification_feedbacks_created extends \core\event\base {
    /**
     * Init method.
     *
     * @return void
    ...
    public function get_description() {
        ...
        if($certification_feedbacks_name){
            ...
            return get_string("strcerficationfeedbacksnamecreated",'local_certification',$stringHelper);
        }else{
            ...
            $stringHelper->userid=$this->userid;
            $stringHelper->objectid=$this->objectid;
            return get_string("strcerficationfeedbackscreated",'local_certification',$stringHelper);
        }
    ...
    public static function get_name() {
        return get_string('eventcertificationfeedbacks_created', 'local_certification');
    }
