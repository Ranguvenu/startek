...
class certification_courses_created extends \core\event\base {
    /**
     * Init method.
     *
     * @return void
    ...
    public function get_description() {
        ...
        if($courseid){
            ...
            return get_string("strcerficationidcoursescreated",'local_certification',$stringHelper);
        }else{
            $stringHelper=new stdClass();
            $stringHelper->firstname=$firstname;
            $stringHelper->userid=$this->userid;
            $stringHelper->objectid=$this->objectid;
            return get_string("strcerficationcoursescreated",'local_certification',$stringHelper);
        }
    }
    ...
    public static function get_name() {
        return get_string('eventcertificationcourses_created', 'local_certification');
    }
