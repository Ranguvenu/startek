...
class certification_completions_settings_updated extends \core\event\base {
    /**
     * Init method.
     *
     * @return void
    ...
    public function get_description() {
        ...
        if($certification_id){
            ...
            return get_string("strcerficationidcsupdated",'local_certification',$stringHelper);
        }else{
            $stringHelper=new stdClass();
            $stringHelper->userid=$this->userid;
            $stringHelper->objectid=$this->objectid;
            return get_string("strcerficationcsupdated",'local_certification',$stringHelper);
        }
    ...
    public static function get_name() {
        return get_string('eventcertificationcompletions_settings_updated', 'local_certification');
    }
