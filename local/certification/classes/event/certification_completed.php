...
class certification_completed extends \core\event\base {
    ...
    public function get_description() {
        ...
        if($certification_name){
            ...
            return get_string("strcerficationnamecompleted",'local_certification',$stringHelper);
        }else{
            $stringHelper=new stdClass();
            $stringHelper->userid=$this->userid;
            $stringHelper->objectid=$this->objectid;
            return get_string("strcerficationcompleted",'local_certification',$stringHelper);
        }
    }
    ...
    public static function get_name() {
        return get_string('eventcertificationcompleted', 'local_certification');
    }
