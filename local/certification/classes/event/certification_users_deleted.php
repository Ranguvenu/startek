...
class certification_users_deleted extends \core\event\base {
    /**
     * Init method.
     *
     * @return void
    ...
    public function get_description() {
        ...
        if($userid){
            ...
            return get_string("strcerficationusersnamedeleted",'local_certification',$stringHelper);
        }else{
            $stringHelper=new stdClass();
            $stringHelper->firstname=$firstname;
            $stringHelper->userid=$this->userid;
            $stringHelper->objectid=$this->objectid;
            return get_string("strcerficationusersdeleted",'local_certification',$stringHelper);
        }
    }
    ...
    public static function get_name() {
        return get_string('eventcertificationusers_deleted', 'local_certification');
    }
    ...
    public function get_url() {
        ...
        $userid=$DB->get_field_sql("SELECT userid FROM {local_certification_users} where id=$this->objectid");
        if($userid){
           $url = new \moodle_url('/local/certification/view.php',array('ctid'=>$this->objectid));
        }else{
