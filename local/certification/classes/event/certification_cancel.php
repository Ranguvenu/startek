...
class certification_cancel extends \core\event\base {
    /**
     * Init method.
     *
     * @return void
    ...
    public function get_description() {
        ...
        if($certification_name){
            ...
            return get_string("strcerficationnamecancel",'local_certification',$stringHelper);
        }else{
            $stringHelper=new stdClass();
            $stringHelper->userid=$this->userid;
            $stringHelper->objectid=$this->objectid;
            return get_string("strcerficationcancel",'local_certification',$stringHelper);
        }
    ...
    public static function get_name() {
        return get_string('eventcertificationcancel', 'local_certification');
    }
