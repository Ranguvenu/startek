...
class certification implements renderable, templatable {
    /**
    ...
    public function __construct() {
        ...
        $this->plugin_name = 'certification';
    }
    /**
    ...
    public function export_for_template(renderer_base $output) {
        ...
        $data->creatacertification = ((has_capability('local/certification:managecertification',
