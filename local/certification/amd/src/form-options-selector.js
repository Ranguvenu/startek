    ...
    return /** @alias module:tool_lp/form-option-selector */ {
        ...
        transport: function(selector, query, success, failure) {
            var promise;
                ...
                if (action === 'certification_institute_selector') {
                ...
                } else if (action === 'certification_costcenter_selector') {
            ...
            promise = Ajax.call([{
                methodname: 'local_certification_form_option_selector',
                args: {
                    query: query,
            ...
            promise[0].then(function(results) {
                ...
                // Render the label.
                $.each(results, function(index, option) {
                    promises.push(Templates.render('local_certification/form-option-selector-suggestion', option));
                });
