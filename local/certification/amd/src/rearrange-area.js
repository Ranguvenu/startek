...
/**
 * AMD localule used when rearranging a custom certification.
 *
 * @localule     local_certification/rearrange-area
 * @package    local_certification
 * @copyright  2016 Mark Nelson <markn@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
define(['jquery', 'core/yui', 'core/fragment', 'local_certification/dialogue', 'core/notification',
        ...
        function($, Y, fragment, Dialogue, notification, str, template, ajax) {
            ...
            RearrangeArea.prototype.CERTIFICATION_REF_POINT_TOPLEFT = 0;
            RearrangeArea.prototype.CERTIFICATION_REF_POINT_TOPCENTER = 1;
            RearrangeArea.prototype.CERTIFICATION_REF_POINT_TOPRIGHT = 2;
            ...
            RearrangeArea.prototype._editElement = function(event) {
                ...
                fragment.loadFragment('local_certification', 'editelement', contextid, params).done(function(html, js) {
                    str.get_string('editelement', 'local_certification').done(function(title) {
                ...
                body.on('click', '#id_submitbutton', function(e) {
                    ...
                    this._saveElement(elementid).then(function() {
                        ...
                        this._getElementHTML(elementid).done(function(html) {
                            ...
                            var refpointClass = '';
                            if (refpoint == this.CERTIFICATION_REF_POINT_TOPLEFT) {
                                refpointClass = 'refpoint-left';
                            } else if (refpoint == this.CERTIFICATION_REF_POINT_TOPCENTER) {
                                refpointClass = 'refpoint-center';
                            } else if (refpoint == this.CERTIFICATION_REF_POINT_TOPRIGHT) {
            ...
            RearrangeArea.prototype._setPosition = function(elementid, refpoint, posx, posy) {
                ...
                switch (refpoint) {
                    case this.CERTIFICATION_REF_POINT_TOPCENTER:
                        posx -= nodewidth / 2;
                        break;
                    case this.CERTIFICATION_REF_POINT_TOPRIGHT:
            ...
            RearrangeArea.prototype._getElementHTML = function(elementid) {
                ...
                var promises = ajax.call([{
                    methodname: 'local_certification_get_element_html',
                    args: {
            ...
            RearrangeArea.prototype._saveElement = function(elementid) {
                ...
                var promises = ajax.call([{
                    methodname: 'local_certification_save_element',
                    args: {
                        templateid: templateid,
                        elementid: elementid,
                        values: inputs
