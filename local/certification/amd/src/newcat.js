...
define(['jquery', 'core/str', 'core/modal_factory', 'core/modal_events', 'core/fragment', 'core/ajax', 'core/yui'],
    ...
    NewCat.prototype.init = function(args) {
        ...
        // $('.'+args.selector).click(function(){
            ...
            return Str.get_string('adnewcat', 'local_certification').then(function(title) {
                // Create the modal.
    ...
    NewCat.prototype.getBody = function(formdata) {
        ...
        return Fragment.loadFragment('local_certification', 'new_catform', this.contextid, params);
    };
