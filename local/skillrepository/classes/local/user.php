...
class user{
    ...
    public function user_team_content($user){
        ...
        {
            $templatedata = array();
            $templatedata['competency_link'] = $CFG->wwwroot.'/local/skillrepository/user_competency.php?userid='.$user->id;
    ...
    public function user_team_headers(){
        ...
        if($advance)
        {
          return array('skillrepository' => get_string('pluginname', 'local_skillrepository'));
        }
    }
}
