...
$string['certificationenddate'] = 'Certificate end date';
$string['certificationgradedate'] = 'Certificate grade date';
$string['certificationstartdate'] = 'Certificate start date';
