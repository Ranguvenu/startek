...
class element extends \local_certificates\element {
    ...
    public function render($pdf, $preview, $user, $moduleinfo = false) {
        ...
        $modulename = \local_certificates\element_helper::get_modulename($this->get_id(),$user, $moduleinfo);
        \local_certificates\element_helper::render_content($pdf, $this,  $modulename);
    }
    ...
    public function render_html() {
        ...
        $modulename = \local_certificates\element_helper::get_modulename($this->get_id(), 2, $this->get_moduleinfo());
        return \local_certificates\element_helper::render_html_content($this, $modulename);
    }
}
