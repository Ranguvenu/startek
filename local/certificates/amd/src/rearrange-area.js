...
/**
 * AMD localule used when rearranging a custom certificate.
 *
 * @localule     local_certificates/rearrange-area
 * @package    local_certificates
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
define(['jquery', 'core/yui', 'core/fragment', 'local_certificates/dialogue', 'core/notification',
        ...
        function($, Y, fragment, Dialogue, notification, str, template, ajax) {
            ...
            RearrangeArea.prototype._editElement = function(event) {
                ...
                fragment.loadFragment('local_certificates', 'editelement', contextid, params).done(function(html, js) {
                    str.get_string('editelement', 'local_certificates').done(function(title) {
            ...
            RearrangeArea.prototype._getElementHTML = function(elementid) {
                ...
                var promises = ajax.call([{
                    methodname: 'local_certificates_get_element_html',
                    args: {
            ...
            RearrangeArea.prototype._saveElement = function(elementid) {
                ...
                var promises = ajax.call([{
                    methodname: 'local_certificates_save_element',
                    args: {
                        templateid: templateid,
                        elementid: elementid,
                        values: inputs
