YUI.add('moodle-local_certificates-rearrange', function (Y, NAME) {
...
Y.extend(Rearrange, Y.Base, {
    ...
    savepositions: function(e) {
        ...
        Y.io(M.cfg.wwwroot + '/local/certificates/customcertajax.php', {
            method: 'POST',
            data: params,
            on: {
...
Y.namespace('M.local_certificates.rearrange').init = function(templateid, page, elements) {
