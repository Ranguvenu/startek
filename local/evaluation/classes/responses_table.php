...
class local_evaluation_responses_table extends table_sql {
    ...
    protected function init($group = 0) {
        ...
        // $extrafields = \core_user\fields::get_extra_user_fields($this->get_context());
        $extrafields = \core_user\fields::for_identity($context)->including('email')->get_required_fields();
