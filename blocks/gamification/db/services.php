...
$functions = [
    'block_gamification_search_courses' => [
        'classname' => 'block_gamification\external',
        'methodname' => 'search_courses',
        'description' => 'Search for courses',
        'type' => 'read',
        'ajax' => true
    ],
    'block_gamification_search_modules' => [
        'classname' => 'block_gamification\external',
    ...
    'block_gamification_set_default_levels_info' => [
        'classname' => 'block_gamification\external',
    ...
    'block_gamification_set_levels_info' => [
        'classname' => 'block_gamification\external',
