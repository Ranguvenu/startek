...
$capabilities = array(
    ...
    'block/gamification:manage' => array(
        'captype' => 'write',
        ...
        'clonepermissionsfrom' => 'block/gamification:addinstance'
    ),

    // Whether or not a user can earn experience point.
    'block/gamification:earngamification' => array(
        'captype' => 'read',
    ...
    'block/gamification:viewlogs' => array(
        'captype' => 'read',
        'contextlevel' => CONTEXT_COURSE,
        'archetypes' => array(
            'editingteacher' => CAP_ALLOW,
        ...
        'clonepermissionsfrom' => 'block/gamification:manage'
    ),

    // Whether or not a user can view the report.
    'block/gamification:viewreport' => array(
        'captype' => 'read',
        'contextlevel' => CONTEXT_COURSE,
        'archetypes' => array(
            'editingteacher' => CAP_ALLOW,
