YUI.add('moodle-block_gamification-rulepicker', function (Y, NAME) {
 ...
 *
 * @module     moodle-block_gamification-rulepicker
 * @package    block_gamification
 * @copyright  2014 Frédéric Massart
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @main       moodle-block_gamification-rulepicker
 */
...
var CSS = {
    INFO: 'info',
    PREFIX: 'block_gamification-rulepicker',
    RULE: 'rule',
};
var SELECTORS = {
    RULE: '.rule'
...
Y.namespace('M.block_gamification').RulePicker = Y.extend(PICKER, M.core.dialogue, {
    ...
    prepare: function() {
        ...
        html += '      aria-describedby="block_gamification_rulepicker_rule_title_{{id}}">';
        html += '   <h3 id="block_gamification_rulepicker_rule_title_{{id}}">{{ name }}</h3>';
        html += '   {{#info}}';
...
Y.Base.modifyAttrs(Y.namespace('M.block_gamification.RulePicker'), {
...
Y.namespace('M.block_gamification.RulePicker').init = function(config) {
