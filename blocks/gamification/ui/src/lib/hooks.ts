...
export const useString = (id: string, component: string = 'block_gamification', a?: any) => {
...
export const useStrings = <T extends string>(ids: T[], component: string = 'block_gamification') => {
