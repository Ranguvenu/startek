...
class di {
    ...
    protected static function make_container() {
        if (local\plugin\addon::should_activate()) {
            $container = new \local_gamification\local\container();
        } else {
            $container = new \block_gamification\local\default_container();
        }
        return $container;
    }
     ...
     * Set the container.
     *
     * @param \block_gamification\local\container $container The container.
     */
    public static function set_container(\block_gamification\local\container $container) {
        if (!PHPUNIT_TEST) {
