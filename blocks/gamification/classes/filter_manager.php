 ...
 */
class block_gamification_filter_manager {

    /**
     * Constructor.
     *
     * @param block_gamification_manager $manager The gamification manager.
     */
    public function __construct(block_gamification_manager $manager) {
    }
