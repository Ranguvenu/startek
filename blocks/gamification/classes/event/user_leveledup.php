...
class user_leveledup extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event_user_leveledup', 'block_gamification');
    }

    /**
     * Get URL related to the action.
     *
     * @return block_gamification\local\routing\url
     */
    public function get_url() {
        return \block_gamification\di::get('url_resolver')->reverse('report', ['courseid' => $this->courseid]);
    }
