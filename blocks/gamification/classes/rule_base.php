 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class block_gamification_rule_base extends block_gamification_rule {
    ...
    protected function get_compare_select($basename) {
        return html_writer::select(array(
                self::CT => get_string('rule:' . self::CT, 'block_gamification'),
                self::EQ => get_string('rule:' . self::EQ, 'block_gamification')
