 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class block_gamification_form_duration extends \MoodleQuickForm_duration {
     ...
     * @param array $attributes Attributes.
     */
    public function block_gamification_form_duration($elementname = null, $elementlabel = null, $options = [], $attributes = null) {
        if (isset($options['maxunit'])) {
            $this->_options['maxunit'] = $options['maxunit'];
        }
...
MoodleQuickForm::registerElementType('block_gamification_form_duration', __FILE__, 'block_gamification_form_duration');
