 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class block_gamification_form_itemspertime extends \MoodleQuickForm_group {
     ...
     * @param array $attributes Attributes.
     */
    public function block_gamification_form_itemspertime($elementname = null, $elementlabel = null, $options = [], $attributes = null) {
        $options = (array) $options;
        $this->_options = array_merge($this->_options, $options);
    ...
    function _createElements() { // @codingStandardsIgnoreLine
        ...
        $in = $this->my_create_element('static', '', '', get_string('pointsintimelinker', 'block_gamification'));
        $this->_elements[] = $in;
...
MoodleQuickForm::registerElementType('block_gamification_form_itemspertime', __FILE__, 'block_gamification_form_itemspertime');
