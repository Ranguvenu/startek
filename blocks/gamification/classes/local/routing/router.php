...
namespace block_gamification\local\routing;
...
class router {
     ...
     * @return block_gamification\local\controller\controller_interface
     */
    protected function get_controller_from_request(routed_request $request) {
        $route = $request->get_route();
        $name = $route->get_definition()->get_controller_name();
        $class = "block_gamification\\local\\controller\\{$name}_controller";
