...
class default_container implements container {
    ...
    protected function get_ajax_base_url() {
        return new moodle_url('/blocks/gamification/ajax.php');
    }
    ...
    protected function get_ajax_router() {
        return new \block_gamification\local\routing\router(
    ...
    protected function get_ajax_routes_config() {
        return new \block_gamification\local\routing\ajax_routes_config();
    }
    ...
    protected function get_ajax_url_resolver() {
        return new \block_gamification\local\routing\default_url_resolver(
    ...
    protected function get_badge_url_resolver() {
        return new \block_gamification\local\gamification\file_storage_badge_url_resolver(\context_system::instance(), 'block_gamification', 'defaultbadges', 0);
    }
    ...
    protected function get_base_url() {
        return new moodle_url('/blocks/gamification/index.php');
    }
    ...
    protected function get_block_class() {
        return 'block_gamification\local\block\course_block';
    }
    ...
    protected function get_block_edit_form_class() {
        return 'block_gamification\form\edit_form';
    }
    ...
    protected function get_collection_logger() {
        return new \block_gamification\local\logger\global_collection_logger($this->get('db'));
    }
    ...
    protected function get_collection_strategy() {
        return new \block_gamification\local\strategy\global_collection_strategy(
    ...
    protected function get_config() {
        return new \block_gamification\local\config\admin_config(
            new \block_gamification\local\config\default_admin_config()
        );
    }
    ...
    protected function get_config_locked() {
        return new \block_gamification\local\config\mdl_locked_config('block_gamification', [
            'identitymode'
        ]);
    }
    ...
    protected function get_course_world_block_instance_finder() {
        return new \block_gamification\local\block\course_world_instance_finder($this->get('db'));
    }
    ...
    protected function get_course_world_factory() {
        return new \block_gamification\local\factory\default_course_world_factory(
            $this->get('config'),
            $this->get('db'),
            new \block_gamification\local\factory\default_badge_url_resolver_course_world_factory(
    ...
    protected function get_course_world_leaderboard_factory_with_config() {
        return new \block_gamification\local\factory\default_course_world_leaderboard_factory($this->get('db'));
    }
    ...
    protected function get_course_world_navigation_factory() {
        return new \block_gamification\local\factory\default_course_world_navigation_factory(
    ...
    protected function get_file_server() {
        global $CFG;
        return new \block_gamification\local\file\file_server(get_file_storage(), $this->get('config')->get('context'));
    }
    ...
    protected function get_observer_rules_maker() {
        return new \block_gamification\local\observer\default_observer_rules_maker();
    }
    ...
    protected function get_renderer() {
        ...
        return $PAGE->get_renderer('block_gamification');
    }
    ...
    protected function get_routes_config() {
        return new \block_gamification\local\routing\default_routes_config();
    }
    ...
    protected function get_rule_event_lister() {
        return new \block_gamification\local\rule\event_lister($this->get('config'));
    }
    ...
    protected function get_settings_maker() {
        return new \block_gamification\local\setting\default_settings_maker(
            new \block_gamification\local\config\default_admin_config(),
            $this->get('url_resolver'),
            $this->get('config_locked')
        );
    ...
    protected function get_shortcodes_definition_maker() {
        return new \block_gamification\local\shortcode\default_shortcodes_definition_maker();
    }
    ...
    protected function get_tasks_definition_maker() {
        return new \block_gamification\local\task\default_tasks_definition_maker();
    }
    ...
    protected function get_usage_reporter() {
        ...
        return new \block_gamification\local\plugin\usage_reporter($config, new plugin\usage_report_maker($this->get('db'), $config));
    }
    ...
    protected function get_user_generic_indicator() {
        return new \block_gamification\local\indicator\prefs_user_indicator($this->get('db'), 'generic');
    }
    ...
    protected function get_user_notice_indicator() {
        return new \block_gamification\local\indicator\user_notice_indicator($this->get('db'));
    }
