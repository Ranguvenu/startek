...
class described_level implements level, level_with_description, level_with_name {
    ...
    /** @var int The level. */
    protected $level;
    /** @var int The gamification required. */
    protected $gamificationrequired;
     ...
     * @param int $gamificationrequired The gamification required.
     * @param string $desc The description.
     * @param string|null $name The name.
     */
    public function __construct($level, $gamificationrequired, $desc, $name = null) {
        $this->level = $level;
        $this->gamificationrequired = $gamificationrequired;
        $this->desc = $desc;
        $this->name = $name;
    }
     ...
     * @return int
     */
    public function get_gamification_required() {
