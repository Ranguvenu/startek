...
class badged_level extends described_level implements level_with_badge {
     ...
     */
    public function __construct($level, $gamificationrequired, $desc, badge_url_resolver $resolver, $name = null) {
        parent::__construct($level, $gamificationrequired, $desc, $name);
