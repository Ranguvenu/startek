...
class course_world_instance_finder implements instance_finder, instances_finder_in_context, any_instance_finder_in_context {
    ...
    protected function get_candidates_in_context($name, context $context) {
        ...
        if ($name !== 'gamification') {
            throw new coding_exception('This implementation is only meant to be used with block_gamification.');
        }

        // The world is in a course context, this means that we are not in whole site mode
        // and we can defer that to our default finder as we egamificationect to be finding the block
        ...
        if ($context instanceof context_course) {
            ...
            throw new coding_exception('Invalid context passed, egamificationected course or system.');
        }
