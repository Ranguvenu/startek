...
class admin_visuals_controller extends admin_route_controller {
    ...
    protected $sectionname = 'block_gamification_default_visuals';
    ...
    protected function define_form() {
        return new \block_gamification\form\visuals($this->pageurl->out(false), ['fmoptions' => $this->get_filemanager_options()]);
    }
    ...
    protected function get_initial_form_data() {
        ...
        file_prepare_draft_area($draftitemid, $this->get_filemanager_context()->id, 'block_gamification', 'defaultbadges',
    ...
    protected function save_form_data($data) {
        file_save_draft_area_files($data->badges, $this->get_filemanager_context()->id, 'block_gamification', 'defaultbadges', 0,
    ...
    protected function content() {
        ...
        echo $output->heading(get_string('defaultvisuals', 'block_gamification'));
    ...
    protected function intro() {
        echo html_writer::tag('p', get_string('admindefaultvisualsintro', 'block_gamification'));
    }
