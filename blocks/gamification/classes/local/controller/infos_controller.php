...
use block_gamification\form\instructions;
...
class infos_controller extends page_controller {
    ...
    protected function get_page_html_head_title() {
        return get_string('infos', 'block_gamification');
    }
    ...
    protected function page_content() {
        ...
        if ($isediting) {
            ...
            echo html_writer::div(format_text($instructions, $instructionsformat), 'block_gamification-instructions');
        }
        ...
        if (!$isediting && $canmanage) {
            ...
            echo html_writer::tag('p',
                $output->single_button(
                    ...
                    get_string($hasinstructions ? 'editinstructions' : 'addinstructions', 'block_gamification'),
                    'get'
                )
            );
        }
        ...
        if ($canmanage) {
            ...
            echo html_writer::tag('p',
                $output->single_button(
                    ...
                    get_string('customizelevels', 'block_gamification'),
                    'get'
                )
            );
        }
