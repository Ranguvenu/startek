...
abstract class route_controller implements controller {
    ...
    /** @var \block_gamification\local\request The request. */
    protected $request;
    /** @var url The page URL, not relative to the router. */
    protected $pageurl;
    /** @var \renderer_base A renderer. */
    protected $renderer;
    /** @var \block_gamification\local\routing\url_resolver URL resolver. */
     ...
     * Handle the request.
     *
     * @param \block_gamification\local\routing\routed_request $request The request.
     * @return void
     */
    final public function handle(\block_gamification\local\routing\request $request) {
        if (!$request instanceof \block_gamification\local\routing\routed_request) {
    ...
    final protected function start() {
        ...
        echo html_writer::start_div('block_gamification');
    }
