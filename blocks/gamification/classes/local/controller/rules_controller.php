...
class rules_controller extends page_controller {
    ...
    /** @var \block_gamification\local\course_filter_manager The filter manager. */
    ...
    protected function get_page_html_head_title() {
        return get_string('courserules', 'block_gamification');
    }
    ...
    protected function get_available_rules() {
        return [
            ...
            (object) [
                'name' => get_string('rulecm', 'block_gamification'),
                'info' => get_string('rulecminfo', 'block_gamification'),
                'rule' => new \block_gamification_rule_cm($this->courseid),
            ],
            // (object) [
    ...
    protected function page_content() {
        ...
        if ($this->get_param('reset')) {
            echo $output->confirm(
                get_string('reallyresetcourserulestodefaults', 'block_gamification'),
    ...
    protected function page_danger_zone_content() {
        ...
        echo html_writer::tag('p',
            $output->single_button(
                ...
                get_string('resetcourserulestodefaults', 'block_gamification'),
                'get'
            )
        );
    }
