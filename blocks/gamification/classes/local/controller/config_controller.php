...
class config_controller extends page_controller {
    ...
    protected function define_form($unused = false) {
        return new \block_gamification\form\config($this->pageurl->out(false), $this->define_form_customdata());
    }
    ...
    protected function get_page_html_head_title() {
        return get_string('coursesettings', 'block_gamification');
    }
    ...
    protected function page_note() {
        ...
        if ($thoselocked) {
            echo html_writer::tag('p', html_writer::tag('small', get_string('notesomesettingslocked', 'block_gamification')));
        }
    }
