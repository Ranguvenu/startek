...
abstract class course_route_controller extends route_controller {
    ...
    /** @var \block_gamification\local\course_world */
    protected $world;
    /** @var \block_gamification\local\factory\course_world_navigation_factory The navigation factory. */
    ...
    protected function post_login() {
        parent::post_login();
        $this->world = \block_gamification\di::get('course_world_factory')->get_world($this->courseid);
        $this->courseid = $this->world->get_courseid();
        $this->navfactory = \block_gamification\di::get('course_world_navigation_factory');
    }
