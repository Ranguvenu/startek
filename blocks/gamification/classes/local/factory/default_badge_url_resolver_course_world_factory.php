...
use block_gamification\local\gamification\badge_url_resolver;
...
class default_badge_url_resolver_course_world_factory
     ...
     * @return block_gamification\local\gamification\badge_url_resolver
     */
    public function get_url_resolver(course_world $world) {
        ...
        if ($custombadges == course_world_config::CUSTOM_BADGES_NOOP) {
            ...
            $resolver = new \block_gamification\local\gamification\file_storage_badge_url_resolver($world->get_context(), 'block_gamification', 'badges', 0);
            ...
            $resolver = new \block_gamification\local\gamification\dummy_badge_url_resolver();
        }
