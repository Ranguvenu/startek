...
use block_gamification\local\config\immutable_config;
...
class default_course_world_factory implements course_world_factory {
     ...
     * @return block_gamification\local\course_world
     */
    public function get_world($courseid) {
        ...
        if (!isset($this->worlds[$courseid])) {
            ...
            $this->worlds[$courseid] = new \block_gamification\local\course_world($config, $this->db, $courseid, $this->urlresolverfactory);
        }
