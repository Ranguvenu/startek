...
class context_permissions implements access_permissions, access_logs_permissions, access_report_permissions {
    ...
    public function can_access($userid = null) {
        return has_capability('block/gamification:view', $this->context, $userid) || $this->can_manage($userid);
    }
    ...
    public function can_access_logs($userid = null) {
        return has_capability('block/gamification:viewlogs', $this->context, $userid);
    }
    ...
    public function can_access_report($userid = null) {
        return has_capability('block/gamification:viewreport', $this->context, $userid);
    }
    ...
    public function can_manage($userid = null) {
        return has_capability('block/gamification:manage', $this->context, $userid);
    }
    ...
    public function require_access($userid = null) {
        if (!$this->can_manage($userid)) {
            return require_capability('block/gamification:view', $this->context, $userid);
        }
    }
    ...
    public function require_access_logs($userid = null) {
        return require_capability('block/gamification:viewlogs', $this->context, $userid);
    }
    ...
    public function require_access_report($userid = null) {
        return require_capability('block/gamification:viewreport', $this->context, $userid);
    }
    ...
    public function require_manage($userid = null) {
        return require_capability('block/gamification:manage', $this->context, $userid);
    }
}
