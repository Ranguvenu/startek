 ...
 * for the legacy value $CFG->block_gamification_context which sits in a different namespace.
 *
 * @package    block_gamification
 * @copyright  2017 Frédéric Massart
 * @author     Frédéric Massart <fred@branchup.tech>
...
class admin_config extends mdl_config {
    ...
    public function __construct(config $defaults) {
        parent::__construct('block_gamification', $defaults);
    ...
    public function get($name) {
        ...
        // Legacy hack.
        if ($name === 'context') {
            $value = get_config('core', 'block_gamification_context');
            if ($value === false) {
    ...
    public function get_all() {
        ...
        $all = parent::get_all();
        if (isset($CFG->block_gamification_context)) {
            $all['context'] = $CFG->block_gamification_context;
        }
    ...
    public function set($name, $value) {
        ...
        // Legacy hack.
        if ($name === 'context') {
            return set_config('block_gamification_context', $value);
        }
