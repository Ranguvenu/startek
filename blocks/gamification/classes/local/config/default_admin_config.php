...
namespace block_gamification\local\config;
...
class default_admin_config extends immutable_config {
    ...
    public function __construct() {
        parent::__construct(new static_config([
            ...
            'laddercols' => 'gamification,progress',
            'levelsdata' => '',
            'maxactionspertime' => 1,//10
            'neighbours' => 0,
            'rankmode' => course_world_config::RANK_ON,
            'timebetweensameactions' => 0,//180
             'timeformaxactions' => 0,//60

            'blocktitle' => get_string('gamification_title', 'block_gamification'),
            'blockdescription' => get_string('participatetogamification', 'block_gamification'),
