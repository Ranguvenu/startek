...
use moodle_url;
use renderable;
use block_gamification\local\gamification\rank;
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class gamification_widget implements renderable, templatable {
    ...
    public function export_for_template(renderer_base $renderer) {
        ...
        return [
            ...
            // Level and gamification.
            'badgehtml' => $badgehtml,
            'levelnamehtml' => $renderer->level_name($level),
            'gamification' => $renderer->gamification_human($this->state->get_gamification()),
            'gamificationhtml' => $renderer->gamification($this->state->get_gamification()),
            ...
            'rankingsnapshot' => array_values(array_map(function($rank, $idx) use ($fallbackpic, $renderer) {
                ...
                if ($this->rankisrel) {
                    ...
                    $diff = $state->get_gamification() - $this->state->get_gamification();
                }
                $diffprefix = $diff > 0 ? '+' : '';
                ...
                return [
                    ...
                    'diff' => $diffprefix . $renderer->gamification_human($diff),
                    'diffhtml' => $diffprefix . $renderer->gamification($diff),
            ...
            'actionshtml' => !empty($this->actions) ? $renderer->gamification_widget_navigation($this->actions) : '',
