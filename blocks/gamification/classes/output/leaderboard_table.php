...
class leaderboard_table extends flexible_table {
     ...
     * @return string Output produced.
     */
    public function col_gamification($row) {
        return $this->gamificationoutput->gamification($row->state->get_gamification());
    }
    ...
    public function col_userpic($row) {
        ...
        return $this->gamificationoutput->user_avatar($picture, $link);
    }
        ...
        if (!$this->started_output) {
            ...
            if ($this->use_pages) {
                ...
                if ($this->showpagesizeselector && $this->totalrows > 20) {
                    echo $this->gamificationoutput->pagesize_selector([
                        [20, $url20],
                        [50, $url50],
                        [100, $url100],
                    ], $this->pagesize);
                ...
                echo $this->gamificationoutput->render($pagingbar);
            }
        }
    }
    ...
    public function print_nothing_to_display() {
        echo \html_writer::div(
            \block_gamification\di::get('renderer')->notification_without_close(
                get_string('ladderempty', 'block_gamification'),
                'info'
            ),
            '',
            ['style' => 'margin: 1em 0']
    ...
    protected function rank_to_keyed_data($rank) {
        ...
        return [
            ...
            'gamification' => $this->col_gamification($row),
