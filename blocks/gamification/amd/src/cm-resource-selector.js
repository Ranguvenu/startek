...
define(['jquery', 'core/ajax', 'block_gamification/throttler', 'block_gamification/resource-selector'], function($, Ajax, Throttler, ResourceSelector) {
    /**
    ...
    CmResourceSelector.prototype.fetchAllForCourse = function(courseId) {
        ...
        var calls = [
            {
                methodname: 'block_gamification_search_modules',
                args: searchargs
            }
        ];
