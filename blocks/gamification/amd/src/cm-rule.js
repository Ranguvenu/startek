 ...
 */
define(['jquery', 'core/templates', 'core/str', 'block_gamification/dialogue-base'], function($, Templates, Str, DialogueBase) {
    var SELECTOR_WRAPPER = '.block-gamification-filters';
    var SELECTOR_WIDGET = '.block_gamification-cm-rule-widget';
    var SELECTOR_WIDGET_TRIGGER = '.block_gamification-cm-rule-widget button';
    var SELECTOR_RESOURCE_SELECTOR_WRAPPER = '.block_gamification-cm-selector-widget';
    ...
    Dialogue.prototype._render = function() {
        ...
        return Str.get_string('cmselector', 'block_gamification').then(
            function(title) {
                return Templates.render('block_gamification/cm-selector', {
        ...
        $(SELECTOR_WRAPPER).on('click', SELECTOR_WIDGET_TRIGGER, function(e) {
            ...
            d.on('cm-selected', function(e, resource) {
                ...
                node.find('.cm-selected').text(
                    M.util.get_string('rulecmdescwithcourse', 'block_gamification', {
                        contextname: cm.name,
