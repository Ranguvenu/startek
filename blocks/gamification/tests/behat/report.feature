...
Feature: A report displays students' progress
  ...
  Scenario: Report with visible groups and resetting data
    ...
    Then the following should exist in the "block_gamification-report-table" table:
    ...
    And the following should exist in the "block_gamification-report-table" table:
      | Full name   | Level | Total |
      | Student One | 1     | 63    |
  ...
  Scenario: Use the report to edit a student's total
    ...
    And I follow edit for "Student One" in gamification report
    # And I click on "td[normalize-space(.)='Student One']/parent::tr/descendant::img[@title='Edit']/parent::a" "gamificationath"
