...
use block_gamification\local\config\filtered_config;
use block_gamification\local\config\mdl_locked_config;
use block_gamification\local\config\static_config;
use block_gamification\local\config\table_row_config;
...
class config_test extends base_testcase {
     ...
     *
     * @covers \block_gamification\local\config\mdl_locked_config
     */
    public function test_mdl_locked_config() {
        global $DB;

        $config = new mdl_locked_config('block_gamification', ['testa', 'testb']);
        ...
        // Check that get all returns what is egamificationected.
        $this->assertEquals(['testa' => false, 'testb' => false], $config->get_all());

        // Check that outside modifications are reflected in object.
        set_config('testa_locked', true, 'block_gamification');
        $this->assertTrue($config->get('testa'));
        $this->assertFalse($config->get('testb'));
        set_config('testa_locked', false, 'block_gamification');
        $this->assertFalse($config->get('testa'));
        $this->assertFalse($config->get('testb'));
        ...
        $this->assertFalse((bool) get_config('block_gamification', 'testa_locked'));
        $this->assertTrue((bool) get_config('block_gamification', 'testb_locked'));
        $config->set('testb', false);
        $this->assertFalse($config->get('testa'));
        $this->assertFalse($config->get('testb'));
        $this->assertFalse((bool) get_config('block_gamification', 'testa_locked'));
        $this->assertFalse((bool) get_config('block_gamification', 'testb_locked'));
     ...
     *
     * @covers \block_gamification\local\config\config_stack
     */
    public function test_config_stack_with_locked() {
        ...
        $locked = new mdl_locked_config('block_gamification', ['testa', 'testb']);
        ...
        $locked = new mdl_locked_config('block_gamification', ['testa', 'testb', 'testx']);
     ...
     *
     * @covers \block_gamification\local\config\filtered_config
     */
     ...
     *
     * @covers \block_gamification\local\config\table_row_config
     */
    public function test_table_row_config() {
        ...
        $this->assertFalse($DB->record_exists('phpunit_block_gamification_config', ['courseid' => 1]));
        $config = new table_row_config($DB, 'phpunit_block_gamification_config', $defaults, ['courseid' => 1]);
        ...
        $this->assertTrue($DB->record_exists('phpunit_block_gamification_config', ['courseid' => 1]));
        $this->assertEquals(333, $DB->get_field('phpunit_block_gamification_config', 'intval1', ['courseid' => 1]));
        ...
        $this->assertEquals(444, $DB->get_field('phpunit_block_gamification_config', 'intval2', ['courseid' => 1]));
        $config = new table_row_config($DB, 'phpunit_block_gamification_config', $defaults, ['courseid' => 1]);
        $this->assertEquals(444, $config->get('intval2'));
        ...
        $config = new table_row_config($DB, 'phpunit_block_gamification_config', $defaults, ['courseid' => 2]);
    ...
    public function test_table_row_config_with_null() {
        ...
        $DB->insert_record('phpunit_block_gamification_config', ['courseid' => 1, 'intval1' => 11, 'char1' => 'hh', 'text1' => 'ww']);
        $config = new table_row_config($DB, 'phpunit_block_gamification_config', $defaults, ['courseid' => 1]);
        ...
        $config = new table_row_config($DB, 'phpunit_block_gamification_config', $defaults, ['courseid' => 1], true);
        ...
        $config = new table_row_config($DB, 'phpunit_block_gamification_config', $partialdefaults, ['courseid' => 1], true);
    ...
    protected function make_config_table() {
        ...
        $table = new xmldb_table('phpunit_block_gamification_config');
