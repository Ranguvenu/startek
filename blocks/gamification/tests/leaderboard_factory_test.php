 ...
 * @author     Frédéric Massart <fred@branchup.tech>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @covers     \block_gamification\local\factory\default_course_world_leaderboard_factory
 */
class leaderboard_factory_test extends base_testcase {
    ...
    public function test_plain_factory_without_groups() {
        ...
        $this->assertEquals(get_string('someoneelse', 'block_gamification'), $ranking[0]->get_state()->get_name());
        $this->assertEquals($guestuser->id, $ranking[0]->get_state()->get_id());
        $this->assertEquals(get_string('someoneelse', 'block_gamification'), $ranking[1]->get_state()->get_name());
        $this->assertEquals($guestuser->id, $ranking[1]->get_state()->get_id());
        $this->assertEquals(get_string('someoneelse', 'block_gamification'), $ranking[2]->get_state()->get_name());
        ...
        $this->assertEquals(get_string('someoneelse', 'block_gamification'), $ranking[4]->get_state()->get_name());
        $this->assertEquals($guestuser->id, $ranking[4]->get_state()->get_id());
        $this->assertEquals(get_string('someoneelse', 'block_gamification'), $ranking[5]->get_state()->get_name());
        $this->assertEquals($guestuser->id, $ranking[5]->get_state()->get_id());
        $this->assertEquals(get_string('someoneelse', 'block_gamification'), $ranking[6]->get_state()->get_name());
    ...
    protected function assert_ranking($ranking, array $egamificationected) {
        ...
        $this->assertEquals($i, count($egamificationected));
    }
