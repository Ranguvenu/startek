...
/**
 * Block gamification course world config test.
 *
 ...
 * @author     Frédéric Massart <fred@branchup.tech>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @covers     \block_gamification\local\config\default_course_world_config
 * @covers     \block_gamification\local\config\default_admin_config
 */
