...
- Fixed failing report task due to incorrect reference to gamification+
...
- New shortcode `[gamificationpoints]` to display number of points
...
- Shortcode `[gamificationladder]` with `top` did not display top for neighboured leaderboards
...
- Support for optional activation of Level Up gamification+ for shared hosting (beta)
...
- Level Up is renamed Level Up gamification, and Level Up Plus becomes Level Up gamification+.
...
_Level Up gamification+_ users may be required to upgrade the add-on for some of these changes to take effect.
...
- Changes to filters and rules to support grade-based rewards in _Level Up gamification+_
...
- Include support for the shortcode `gamificationlevelname`
- Compatibility with Moodle 3.8

Bug fixes

- Restored rules are now updating their internal configuration
- Shortcode `gamificationladder` would display even when ladder is disabled
...
- New permission `block/gamification:manage` for more granular management control
...
- The shortcode `gamificationladder` supports displaying the top users
...
- Maintenance for Level Up gamification+ group leaderboards

v3.3.1
------

- Maintenance for Level Up gamification+

v3.3.0
------

- New shortcode `gamificationladder` for displaying the ladder
...
- Changes to support Moodle Mobile in _Level Up gamification+_
...
- Improved compatibility with older plugins depending on Level Up gamification
...
- Made ready for compatibility with the [Level Up gamification+ add-on](https://github.com/FMCorz/moodle-local_gamification)
...
- Fixed a bug where some students with 0 gamification would appear at the top of the report
...
- Fix bug causing visuals not to be displayed when gamification is used site-wide
...
- Egamificationosing some options of the cheat guard
- Report displays all the students, not just the ones with gamification
...
- Ability to customise the gamification gained with rules
...
- New capability controlling who earns gamification
- Admin users do not earn gamification any more
- Customising the levels and the required gamification
- New info page displaying the levels, a description and the gamification required
- Ability to edit the gamification of a user
...
- Basic algorithm and gamification attribution
