...
$string['addoninstallationerror'] = 'We are detecting an issue with the add-on (local_gamification), it does not seem to be installed properly. An administrator should finalise its installation.';
...
$string['awardagamificationwhen'] = '<strong>{$a}</strong> points are earned when:';
$string['basegamification'] = 'Algorithm base';
...
$string['coefgamification'] = 'Algorithm coefficient';
...
$string['discoverlevelupplus'] = 'Discover Level Up gamification+';
...
$string['enablecheatguard_help'] = 'The cheat guard offers a simple inegamificationensive mechanism for preventing students to abuse the system using obvious techniques, such as refreshing the same page endlessly, or repeating the same action over and over again.

[More info](https://docs.levelup.plus/gamification/docs/getting-started/cheat-guard?ref=blockgamification_help)
';
...
$string['enablegamificationgain'] = 'Enable points gain';
$string['enablegamificationgain_help'] = 'When set to \'No\', nobody will earn points in the course. This is useful to freeze the points gained, or to enable it at a certain point in time.

Please note that this can also be controlled more granularly using the capability _block/gamification:earngamification_.';
$string['entersearchterm'] = 'Enter a search term';
$string['errorcontextcoursemismatchforwholesite'] = 'The URL of this <em>Level Up gamification</em> page does not match the current plugin configuration. Your current configuration declares <em>Level Up gamification</em> to be used \'For the whole site\', however this page egamificationected it to be used \'Per course\'. Please <a href="{$a->nexturl}">click here</a> to navigate to the right page. Search for the admin setting \'block_gamification_context\' if you wish to change your configuration.';
$string['errorcontextcoursemismatchpercourse'] = 'The URL of this <em>Level Up gamification</em> page does not match the current plugin configuration. Your current configuration declares <em>Level Up gamification</em> to be used \'Per course\', but this page egamificationects it to be used \'For the whole site\'. It most likely originates from a <em>block</em> that was added to the dashboard or front page while in a different configuration. You should remove the block from the latter pages, and only use the block from within individual courses.';
...
$string['errorgamificationrequiredlowerthanpreviouslevel'] = 'The points required are lower than or equal to the previous level.';
...
- [How are experience points calculated?](https://docs.levelup.plus/gamification/docs/getting-started/points-calculation?ref=blockgamification_help)
- [Troubleshooting rules](https://docs.levelup.plus/gamification/docs/troubleshooting/event-rule-not-working?ref=blockgamification_help)
';
...
$string['invalidgamification'] = 'Invalid points value';
...
$string['levelupplus'] = 'Level Up gamification+';
...
$string['pluginavailabilitygamificationdesc'] = 'This plugin lets instructors restrict access to activities based on students\' levels.';
$string['pluginenrolgamificationdesc'] = 'This plugin enables automatic enrolment into courses based on a student\'s level in another course.';
$string['pluginshortcodesdesc'] = 'This plugin lets instructors customise their material by including gamification related elements (points, level, leaderboard, …) in the content, as well as hiding or showing content based on a student\'s level.';
$string['pluginname'] = 'Gamification';
$string['pluginsoutofsync'] = '__The plugins are out of sync!__

This means that you have upgraded _Level Up gamification_ but not _Level Up gamification+_. While we do our best to try and prevent any issues, some features may no longer function properly, including in _Level Up gamification_ itself. We recommend that you upgrade _Level Up gamification+_ to its latest release. [Read more]({$a->url})';
...
$string['privacy:metadata:log:gamification'] = 'The points awarded for the event';
...
$string['privacy:metadata:gamification'] = 'Stores the points and level of users';
$string['privacy:metadata:gamification:gamification'] = 'The user\'s points';
$string['privacy:metadata:gamification:lvl'] = 'The user\'s level';
$string['privacy:metadata:gamification:userid'] = 'The user';
...
$string['promocheatguard'] = 'This cheat guard is not designed to cover long time frames. Please consider upgrading to <em>Level Up gamification+</em> to unlock greater time frames and other features. <a href="{$a->url}">Read more here</a>.';
$string['promointro'] = 'Become the game master, and unleash Level Up gamification to its full potential. Unlock additional features with Level Up gamification+!';
$string['promointroinstalled'] = 'The add-on _Level Up gamification+_ is installed on your system and all of its features have been enabled.';
$string['promorulesdidyouknow'] = 'Did you know that with <em>Level Up gamification+</em> students can receive points for <em>completing courses</em> and <em>activities</em>, or even receive points according to their <em>grades</em>? <a href="{$a->url}">Discover more here</a>.';
...
Importantly, when using _Level Up gamification_ for the whole site, deleting them will make them disappear from the report, in which case you will not be able to re-assign them points. However, if you are using _Level Up gamification_ per course, the student may still appear in the report if they are enrolled in the course.
...
$string['shortcode:gamificationbadge'] = 'The badge matching the current user\'s level.';
$string['shortcode:gamificationladder'] = 'Display a portion of the leaderboard.';
$string['shortcode:gamificationladder_help'] = '
...
```
[gamificationladder top]
[gamificationladder top=15]
```
...
```
[gamificationladder withprogress]
```

Note that when a course is using groups, the leaderboard will best guess which group to display the leaderboard of.
';
$string['shortcode:gamificationiflevel'] = 'Display the content when the current user\'s level matches.';
$string['shortcode:gamificationiflevel_help'] = '
...
';
$string['shortcode:gamificationlevelname'] = 'Display the level name.';
$string['shortcode:gamificationlevelname_help'] = '
...
[gamificationlevelname level=5]
```

If the `level` argument is provided and the level does not exist, nothing will be displayed.
';
$string['shortcode:gamificationpoints'] = 'Display a number of points formatted as experience points.';
$string['shortcode:gamificationprogressbar'] = 'The current user\'s progress bar towards the next level.';
...
$string['wherearegamificationused'] = 'Where are points used?';
$string['wherearegamificationused_desc'] = 'When set to \'In courses\', the points gained will only account for the course in which the block was added to. When set to \'For the whole site\', a user will "level up" in the site rather than selectively per course, all the points gained throughout the site will be used.';
...
$string['gamification:addinstance'] = 'Add a new block';
$string['gamification:earngamification'] = 'Earning points';
$string['gamification:manage'] = 'Manage all aspects of experience points';
$string['gamification:myaddinstance'] = 'Add the block to my dashboard';
$string['gamification:view'] = 'View the block and its related pages';
$string['gamification:viewlogs'] = 'View the logs';
$string['gamification:viewreport'] = 'View the report';
$string['gamificationgaindisabled'] = 'Points gain disabled';
...
$string['gamification'] = 'experience points';
$string['gamificationrequired'] = 'gamification required';
...
<ul>
    ...
    <li>The actions performed by users not having the capability <em>block/gamification:earngamification</em>.</li>
...
$string['gamificationtogo'] = '[[{$a}]] to go';
$string['gamificationsettings'] = 'Gamification Settings';

$string['gamification_title'] = 'Gamification';
$string['participatetogamification'] = 'Participate in the course to gain points and increase your level!';
$string['gamification_dashboard'] = 'Gamification Dashboard';
