...
$class = \block_gamification\di::get('block_class');
...
class_alias($class, 'block_gamification_block_class');

/**
 * Block gamification class.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class block_gamification extends block_gamification_block_class {
}
