...
class reportbase {
    ...
    function get_all_elements() {
        ...
        if (( $this->config->type == 'coursescompletions' && $this->params['filter_course'] > 0)||( $this->config->type == 'coursegradeactivities' && $this->params['filter_course'] > 0) || ($this->config->type != 'coursegradeactivities' && $this->config->type != 'coursescompletions')) {
            try {
