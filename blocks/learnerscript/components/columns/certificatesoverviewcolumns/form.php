...
class certificatesoverviewcolumns_form extends moodleform {
    ...
    public function definition() {
        ...
        $mform->addElement('header', 'crformheader', get_string('certificatesoverviewcolumns', 'block_learnerscript'), '');
        $coursecolumns = array();
