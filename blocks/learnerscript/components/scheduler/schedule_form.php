	...
	function definition() {
		...
		foreach ($this->_customdata['reportfilters'] as $filter) {
			if ($filter['name'] == 'organization') {
				...
				$mform->addElement('select', 'filter_organization', get_string('open_costcenterid', 'local_costcenter'), $organizations_list, array('data-select2' => true, 'id' => 'id_organization', 'data-id' => $reportid, 'data-class' => $requireclass, 'data-element' => 'organization',
					...
					'data-placeholder' => get_string('selectopen_costcenterid', 'local_costcenter')));
			...
			if ($filter['name'] == 'departments') {
				...
				$mform->addElement('select', 'filter_department', get_string('pluginname', 'local_costcenter'), $departments_list, array('data-select2' => true, 'id' => 'id_department', 'data-id' => $reportid, 'data-class' => $requireclass, 'data-element' => 'department', 
					...
					'data-placeholder' => get_string('filter_department', 'local_costcenter')));
			...
			if ($filter['name'] == 'subdepartments') {
				...
				$mform->addElement('select', 'filter_subdepartment', get_string('open_subdepartment', 'local_costcenter'), $subdepartments_list, array('data-select2' => true, 'id' => 'id_subdepartment', 'data-id' => $reportid, 'data-class' => $requireclass, 'data-element' => 'subdepartment', 
