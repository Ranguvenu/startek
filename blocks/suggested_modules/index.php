...
$heading = get_string('suggested_modules', 'block_suggested_modules');
...
$renderer = $PAGE->get_renderer('block_suggested_modules');
// $filterparams = $renderer->trending_modules_content(true);
echo $OUTPUT->header();
// echo $renderer->display_additional_filters($filterparams);
// echo $OUTPUT->render_from_template('local_costcenter/global_filter', $filterparams);
echo $renderer->suggested_modules_content();
echo $OUTPUT->footer();