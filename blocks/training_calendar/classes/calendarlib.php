...
class calendarlib {
	public static function trainingcalendar_plugin_details(){
		...
		$standard_calendartypes = array(get_string('elear','block_training_calendar'), get_string('classro','block_training_calendar'), get_string('learningpa','block_training_calendar'), get_string('prog','block_training_calendar'), get_string('certific','block_training_calendar'), get_string('onlinete','block_training_calendar'), get_string('feedba','block_training_calendar'));
	    $returnarr = array();
